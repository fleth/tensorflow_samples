...
def make_mini_batch(train_data, index, size_of_mini_batch, size_of_input_data):
    ...
    for _ in range(size_of_mini_batch):
        ...
        outputs = np.vstack((outputs, outputs_part))
...
test_data, test_labels = make_mini_batch(train_data, 200, size_of_mini_batch, num_of_input_nodes)
